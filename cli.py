"""
Command Line Interface for Modified Duke Endocarditis Criteria.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="modified-duke-endocarditis-criteria", description="Modified Duke Endocarditis Criteria")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  MODIFIED DUKE ENDOCARDITIS CRITERIA")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Modified Duke Endocarditis Criteria Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Modified Duke Endocarditis Criteria API server on http://{args.host}:{args.port}")
