"""
Automated Pytest for modified-duke-endocarditis-criteria Enrichment Modules.
"""
import sys
...
from enrichment import (
    ...
    ModifieddukeendocarditiscriteriaEnrichmentSuite,
    enrichment_suite,
)

def test_enrichment_suite_execution():
    suite = ModifieddukeendocarditiscriteriaEnrichmentSuite()
